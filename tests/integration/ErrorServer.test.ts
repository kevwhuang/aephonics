...
const HEADING = '<h1 id="error-server-title" class="mb-[clamp(1.5rem,calc(1rem+2.5vw),3rem)] font-semibold leading-none text-[clamp(6rem,calc(3rem+15vw),15rem)] tracking-widest bg-clip-text bg-linear-to-b from-white-60 text-transparent to-white-40">500</h1>';
...
describe('ErrorServer', () => {
    ...
    test('renders 500 as the only heading', () => {
